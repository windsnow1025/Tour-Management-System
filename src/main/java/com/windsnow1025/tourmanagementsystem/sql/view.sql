...
CREATE VIEW 导游顾客视图 AS
SELECT
    导游.姓名 AS 导游名字,
    顾客.姓名 AS 顾客名字
FROM 旅游信息
         JOIN 导游员工 ON 旅游信息.旅游团_id = 导游员工.旅游团_id
         JOIN 身份信息 AS 导游 ON 导游员工.身份证号 = 导游.身份证号
         JOIN 身份信息 AS 顾客 ON 旅游信息.顾客_身份证号 = 顾客.身份证号;
